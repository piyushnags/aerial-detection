...
class WIDERFaceDataset(Dataset):
    def __init__(self, data_dir: str, annotations: str, transforms: Optional[Callable] = None, split: str = 'train'):
        ...
        if split == 'train':
            degen_images = [
                f'WIDER_train/images/0--Parade/0_Parade_Parade_0_452.jpg',
                f'WIDER_train/images/2--Demonstration/2_Demonstration_Political_Rally_2_444.jpg',
                f'WIDER_train/images/39--Ice_Skating/39_Ice_Skating_iceskiing_39_380.jpg',
                f'WIDER_train/images/46--Jockey/46_Jockey_Jockey_46_576.jpg'
            ]
